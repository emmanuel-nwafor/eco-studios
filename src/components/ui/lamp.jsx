  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-bold tracking-tight text-transparent md:text-6xl">
      <h1 className="relative text-cente m-10 z-20 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text py-8 text-4xl font-bold text-transparent sm:text-6xl">
        I Build Experiences That Are <br />  <ContainerTextFlip />
      </h1>
      <h1 className="text-gray-400 z-20">
        <span className="font-bold text-gray-300">PORTFOLIO{"</>"}</span> <br />

        Building the web, crafting seamless experiences, and <br />
        ensuring every click leaves an impact. I believe great design goes beyond visuals—it <br /> resonates,
        connects, and evokes emotion.
      </h1>
      </motion.h1>
      <br />
      <MovingBorder />
